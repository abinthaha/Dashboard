  ...
  render() {
        ...
        <li key={projectItem.id} className="flip-card">
          <div className="flip-card-inner">
            ...
            <div className="flip-card-back">
              <span className="project-name">{projectItem.projectName}</span>
              <span className="type">{projectItem.type}</span>
    ...
    return (
      <section className="even portfolio-wrapper" id={this.props.elId}>
        ...
        <ul className="project-list-wrapper flip-wrapper">{projectList}</ul>
		<CandleComponent />
      </section>
    );
  }
